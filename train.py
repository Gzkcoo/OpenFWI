...
def parse_args():
    ...
    parser.add_argument('-t', '--train-anno', default='flatvel_a_train.txt', help='name of train anno')
    ...
    # Tensorboard related
    parser.add_argument('--tensorboard', action='store_false', help='Use tensorboard for logging.')
